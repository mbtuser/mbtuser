...
WpfWindow("OpenText MyFlight Sample").WpfButton("FIND FLIGHTS").Click @@ hightlight id_;_1921360688_;_script infofile_;_ZIP::ssf4.xml_;_
WpfWindow("OpenText MyFlight Sample").WpfTable("flightsDataGrid").SelectCell 1,1 @@ hightlight id_;_2020504392_;_script infofile_;_ZIP::ssf7.xml_;_
If WpfWindow("OpenText MyFlight Sample").WpfButton("SELECT FLIGHT").Exist Then
