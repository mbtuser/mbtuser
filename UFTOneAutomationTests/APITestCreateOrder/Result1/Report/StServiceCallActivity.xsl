    ...
    <font face="Calibri">
      <html>
        ...
        <body>
          <table border="0" cellpadding="3" cellspacing="0" width="100%">
            ...
            <tr>
              <td height="30">
                <p>
                  <span class="hl1name">
                    <xsl:copy-of select="$IDS_StServiceCall_WebProperties"/>
                  </span>
                </p>
              </td>
            </tr>
          ...
          <table border="0" cellpadding="3" cellspacing="0" width="100%" >
            ...
            <tr>
              <td height="30">
                <p>
                  <span class="hl1name">
                    <xsl:copy-of select="$IDS_StServiceCall_WebHTTPSnapshot"/>
                  </span>
                </p>
              </td>
            </tr>
          ...
          <p>
            <table border="0" cellpadding="1" cellspacing="1" height="500px" >
              <tr>
                <td>
