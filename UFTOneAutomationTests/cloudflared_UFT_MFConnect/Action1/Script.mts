...
wait(2)
Browser("OpenText MF Connect").Page("OpenText MF Connect").WebButton("Sign In").Click @@ hightlight id_;_65662_;_script infofile_;_ZIP::ssf12.xml_;_
wait(30)

'Browser("OpenText MF Connect_2").Page("OpenText MF Connect").WebButton("Sign In").Click @@ script infofile_;_ZIP::ssf18.xml_;_
Browser("OpenText MF Connect_2").Refresh
Browser("OpenText MF Connect_2").Page("OpenText MF Connect").WebButton("User Settings").Click @@ script infofile_;_ZIP::ssf19.xml_;_
wait(30)
