...
If Browser("Home - Advantage Bank").Page("Home - Advantage Bank").WebButton("Open_2").Exist(5) Then @@ script infofile_;_ZIP::ssf18.xml_;_
	Reporter.ReportEvent micDone, "User already login", "User already login"
	wait(1)
	Browser("Home - Advantage Bank").Page("Home - Advantage Bank").WebButton("Open_2").Click
	wait(1)
	Browser("Home - Advantage Bank").Page("Dashboard - Advantage").WebButton("WebButton_2").Click
	wait(1)
