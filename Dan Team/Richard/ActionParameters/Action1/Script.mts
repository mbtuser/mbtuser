...
Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("username").Set Parameter("username") @@ script infofile_;_ZIP::ssf2.xml_;_
Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("password").SetSecure Parameter("password") @@ script infofile_;_ZIP::ssf3.xml_;_
