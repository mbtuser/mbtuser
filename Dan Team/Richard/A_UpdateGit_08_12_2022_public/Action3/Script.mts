...
If Parameter("Order_Number") > 0 Then
	Reporter.ReportEvent micPass, "Passed Test", "Link to parameters Order_Numper work properly"
	else
	Reporter.ReportEvent micFail, "Failed Test", "Link to parameters Order_Numper Failed"
End If
