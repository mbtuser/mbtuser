...
WpfWindow("OpenText MyFlight Sample").WpfButton("OK").Click @@ hightlight id_;_1925334280_;_script infofile_;_ZIP::ssf28.xml_;_
 ...
 End If @@ hightlight id_;_787428_;_script infofile_;_ZIP::ssf29.xml_;_'
=======
 
 else
 Reporter.ReportEvent micFail, "Failed", "Fail to open the Flight App"
